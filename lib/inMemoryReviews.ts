...
const initialReviews: Review[] = [
  ...
  {
    id: 6,
    restaurant_id: 'fue-cinnabon-campus',
    rating: 5,
  ...
  {
    id: 7,
    restaurant_id: 'p90-costa',
    rating: 4,
    comment: 'Great flat white and quiet seating at Point 90 Mall terrace.',
    user_name: 'Karim H.',
    image_url: null,
  ...
  {
    id: 15,
    restaurant_id: 'fue-costa-campus',
    rating: 5,
    comment: 'Having Costa right on campus next to the engineering building is a lifesaver. Fast barista service!',
    user_name: 'Sherif E.',
    image_url: null,
    price_per_person: 95,
    recommended_dish: 'Signature Flat White',
    created_at: new Date(Date.now() - 1000 * 60 * 60 * 16).toISOString(),
  },
  {
    id: 8,
    restaurant_id: 'p90-chilis',
    rating: 5,
  ...
  {
    id: 9,
    restaurant_id: 'fue-seven-days',
    rating: 5,
    comment: 'Best iced caramel macchiato on campus! The courtyard seating is very relaxing.',
    user_name: 'Ziad N.',
    image_url: null,
    price_per_person: 65,
    recommended_dish: 'Iced Caramel Macchiato',
    created_at: new Date(Date.now() - 1000 * 60 * 60 * 24 * 1).toISOString(),
  },
  {
    id: 10,
    restaurant_id: 'fue-uncle-tonny',
    rating: 5,
    comment: 'The double smash burger is insane. Crispy edges and amazing Tonny sauce, quick between lectures!',
    user_name: 'Mahmoud S.',
    image_url: null,
    price_per_person: 140,
    recommended_dish: 'Double Smash Burger',
    created_at: new Date(Date.now() - 1000 * 60 * 60 * 18).toISOString(),
  },
  {
    id: 11,
    restaurant_id: 'fue-vivo',
    rating: 5,
    comment: 'Authentic pizza crust and the chicken alfredo is super creamy and filling.',
    user_name: 'Farida A.',
    image_url: null,
    price_per_person: 115,
    recommended_dish: 'Chicken Alfredo Fettuccine',
    created_at: new Date(Date.now() - 1000 * 60 * 60 * 36).toISOString(),
  },
  {
    id: 12,
    restaurant_id: 'fue-juice-me-up',
    rating: 5,
    comment: 'Pure cold-pressed orange juice and the mango passion smoothie is 10/10.',
    user_name: 'Hana M.',
    image_url: null,
    price_per_person: 55,
    recommended_dish: 'Mango Passion Smoothie',
    created_at: new Date(Date.now() - 1000 * 60 * 60 * 12).toISOString(),
  },
  {
    id: 13,
    restaurant_id: 'fue-bouza-roll',
    rating: 5,
    comment: 'The Lotus Biscoff rolled ice cream made fresh right in front of you is so good!',
    user_name: 'Kareem T.',
    image_url: null,
    price_per_person: 75,
    recommended_dish: 'Lotus Biscoff Ice Cream Roll',
    created_at: new Date(Date.now() - 1000 * 60 * 60 * 20).toISOString(),
  },
  {
    id: 14,
    restaurant_id: 'fue-saladero',
    rating: 5,
    comment: 'Finally a healthy option on campus! Fresh ingredients, huge portions and great dressing.',
    user_name: 'Nadine K.',
    image_url: null,
    price_per_person: 110,
    recommended_dish: 'Grilled Chicken Caesar Bowl',
