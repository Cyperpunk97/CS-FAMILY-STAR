...
const CONTACTS_BY_BRAND: Record<string, ContactInfo> = {
  ...
  KFC: { logoUrl: '/logos/kfc.svg', logoWidth: 240, logoHeight: 240, signatureDish: 'Mighty Zinger Box & Twister' },
  ...
  'Uncle Tonny': { logoUrl: '/logos/uncle-tonny.svg', logoWidth: 240, logoHeight: 240, signatureDish: 'Uncle Tonny Double Smashed Burger & Crispy Tender Wrap' },
  ...
  'Koshary El Tahrir': { logoUrl: '/logos/koshary-el-tahrir.jpg', logoWidth: 600, logoHeight: 600, signatureDish: 'Tahrir Mega Box with Garlic Da’ah' },
  Cilantro: { logoUrl: '/logos/cilantro.png', logoWidth: 800, logoHeight: 172, signatureDish: 'Iced Spanish Latte & Emmental Croissant' },
  Pasta2Go: { logoUrl: '/logos/pasta-2go.svg', logoWidth: 240, logoHeight: 240, signatureDish: 'Crispy Chicken Alfredo Pasta' },
  'Seven Days Cafe': { signatureDish: 'Iced Caramel Macchiato & Student Toastie' },
  'FUE Central Cafeteria': { logoUrl: '/logos/fue-logo.png', logoWidth: 320, logoHeight: 320, signatureDish: 'Grilled Shish Tawook Plate Meal' },
  ...
  'Abou Shakra': { logoUrl: '/logos/abou-shakra.jpg', logoWidth: 2698, logoHeight: 1699, signatureDish: 'Charcoal Kofta Sandwich Roll' },
  'Coffeeshop Company': { logoUrl: '/logos/coffeeshop-company.png', logoWidth: 330, logoHeight: 391, signatureDish: 'Viennese Melange & Roast Beef Ciabatta' },
  Sugo: { logoUrl: '/logos/sugo.svg', logoWidth: 240, logoHeight: 240, signatureDish: 'حواوشي بالجبنة & سجق شرقي' },
  'B&W (Burgers & Wings)': { logoUrl: '/logos/bw-burger.svg', logoWidth: 240, logoHeight: 240, signatureDish: 'Classic Beef Burger, Fire Wings & Loaded Grilled Chicken' },
  Bimbo: { signatureDish: 'Waffles, Crepes, Ice Cream & Fresh Milkshakes' },
  'Heart Attack': { logoUrl: '/logos/heart-attack.svg', logoWidth: 240, logoHeight: 240, signatureDish: 'Dynamite Stuffed Fried Chicken & Cheesy Fries' },
  Bazooka: { logoUrl: '/logos/bazooka.png', logoWidth: 909, logoHeight: 909, signatureDish: 'Bazooka Crunch Box & Crispy Strips' },
  "Willy's Kitchen": { logoUrl: '/logos/willys-kitchen.svg', logoWidth: 144, logoHeight: 144, signatureDish: 'Nacho Burger & Melted Cheese Syringe' },
  'Mince Burger': { logoUrl: '/logos/mince-burger.svg', logoWidth: 240, logoHeight: 240, signatureDish: 'Juicy Lucy Burger & Rosemary Truffle Fries' },
  Zooba: { logoUrl: '/logos/zooba.svg', logoWidth: 268, logoHeight: 64, signatureDish: 'Spicy Sausage Hawawshi & Gourmet Falafel' },
  "Auntie Anne's": { logoUrl: '/logos/auntie-annes.png', logoWidth: 330, logoHeight: 90, signatureDish: 'Cinnamon Sugar Pretzel & Cheesy Pretzel Dog' },
  Dipndip: { logoUrl: '/logos/dipndip.png', logoWidth: 330, logoHeight: 104, signatureDish: 'Triple Chocolate Crepe & Brownie Skillet' },
  'El Dahan': { logoUrl: '/logos/el-dahan.png', logoWidth: 992, logoHeight: 599, signatureDish: 'Kabab & Kofta Mixed Grill Platter' },
  'Man\'ousha Street': { logoUrl: '/logos/manousha-street.svg', logoWidth: 240, logoHeight: 240, signatureDish: 'Zaatar & Cheese Oven Baked Manouche' },
};
...
const CONTACTS_BY_ID: Record<string, ContactInfo> = {
  ...
  'p90-abou-shakra': { signatureDish: 'Charcoal Kofta Sandwich Roll' },
...
const CATALOG: CatalogEntry[] = [
  ...
  { id: 'p90-brioche-doree', name: 'Brioche Dorée - Point 90', brand: 'Brioche Doree', vicinity: 'Point 90 Mall, Floor 1, New Cairo', category: 'Cafe', lat: 30.0184, lng: 31.4981, coordSource: 'approx', priceTier: 2, isOnCampus: false },
  ...
  { id: 'p90-caffe-pascucci', name: 'Caffè Pascucci - Point 90', brand: 'Caffe Pascucci', vicinity: 'Point 90 Mall, Outdoor Plaza, New Cairo', category: 'Cafe', lat: 30.0183, lng: 31.4977, coordSource: 'approx', priceTier: 2, isOnCampus: false },
  ...
  { id: 'p90-smash-burger', name: 'Smashburger - Point 90 Mall', brand: 'Smash Burger', vicinity: 'Point 90 Mall, Food Court, New Cairo', category: 'Fast Food', lat: 30.0189, lng: 31.4976, coordSource: 'approx', priceTier: 2, isOnCampus: false },
  ...
  { id: 'p90-mince-burger', name: 'Mince Burger - Point 90', brand: 'Mince Burger', vicinity: 'Point 90 Mall, Ground Floor, New Cairo', category: 'Restaurant', lat: 30.0184, lng: 31.4984, coordSource: 'approx', priceTier: 2, isOnCampus: false },
  ...
  { id: 'p90-abou-shakra', name: 'Abou Shakra - Concord Plaza', brand: 'Abou Shakra', vicinity: 'Concord Plaza, South 90th Street, New Cairo', category: 'Restaurant', lat: 30.0242, lng: 31.4775, coordSource: 'approx', priceTier: 2, isOnCampus: false },
