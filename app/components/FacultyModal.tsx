          ...
          {faculties.map((fac) => {
            ...
            return (
              <button
                ...
                className={`w-full text-start p-3.5 rounded-xl border transition flex items-center justify-between ${
                  isSelected
              ...
              >
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <span className="inline-block mt-1 text-xs font-medium text-ink-faint">
                      {fac.building}
                    </span>
                  </div>
                </div>
                ...
                {isSelected && (
                  <div className="flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-brand-600 text-white ms-2">
