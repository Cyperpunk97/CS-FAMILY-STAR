...
export default function ScrollTopButton({ threshold = 700 }: { threshold?: number }) {
  ...
  return (
    <button
      ...
      className="animate-rise fixed bottom-5 end-5 z-40 flex h-11 w-11 items-center justify-center rounded-full bg-brand-700 text-white shadow-lg shadow-brand-900/25 transition hover:bg-brand-800 active:scale-90"
    >
