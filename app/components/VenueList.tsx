  ...
  return (
    <>
        ...
        <div className="min-w-0">
          ...
          <p className="mt-0.5 flex items-center gap-1.5 text-xs text-ink-soft">
            <button
              ...
              className="group inline-flex items-center gap-1 text-left font-semibold text-brand-900 underline decoration-brand-200/80 underline-offset-2 transition hover:text-brand-700 hover:decoration-brand-400"
      ...
      */}
      ...
      {/*
        Dish search. Given the full enriched list rather than the filtered one: the
        venue filters answer "where should I go", and narrowing "who has koshary" by
        them would hide the answer the student actually asked for.
      */}
      <div className="mt-4">
        <DishSearch venues={enrichedVenues} onOpenVenue={setActiveId} />
      </div>
