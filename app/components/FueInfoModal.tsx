        ...
        <div className="flex-1 space-y-6 overflow-y-auto px-6 py-6 sm:px-8">
          ...
          <section className="rounded-2xl border border-hairline bg-card p-5 shadow-xs">
            ...
            <div className="mt-3 space-y-3 text-sm leading-relaxed text-ink-soft">
              ...
              <p className="border-s-2 border-brand-500 ps-3 italic text-ink font-medium">
                ...
                >
                  ...
                  {onSelectFaculty && (
                    <button
                      ...
                      className="mt-3 inline-flex items-center gap-1 text-xs font-bold text-brand-700 transition hover:text-brand-900"
                    >
