    ...
    <div className="space-y-3">
      ...
      <div className="relative">
        <label htmlFor={searchId} className="sr-only">
          Search spots by name, food, or location
        </label>
        <Search
        ...
        <input
          ...
          placeholder="Search restaurants, dishes, cuisines, Point 90, FUE food court..."
          className="w-full rounded-2xl border border-hairline bg-card py-2.5 pl-10 pr-10 text-sm font-medium text-ink placeholder:text-ink-faint shadow-2xs transition duration-200 hover:border-brand-200 focus:border-brand-500 focus:bg-card focus:shadow-md focus:shadow-brand-900/5 focus:outline-none"
        />
        {filters.query ? (
          <button
            type="button"
            ...
            className="absolute right-3 top-1/2 -translate-y-1/2 rounded-full p-1 text-ink-faint transition hover:bg-surface hover:text-ink"
          >
